                         ...
                         <Guard2Context.Provider value={guardresponse2}>
                             <Guard3Context.Provider value={gaurdresponse3}>
                                 <Takedown1Context.Provider value={takedownresponse1}>
                                     <Takedown2Context.Provider value={takedownresponse2}>
                                         <Takedown3Context.Provider value={takedownresponse3}>
                                 ...
                                 <Switch>
                                     ...
                                     <Route exact path='/takedown2' component={TakeDown2}/>
                                     <Route exact path='/takedown3' component={TakeDown3}/>
                                         ...
                                         </Takedown3Context.Provider>
                                     </Takedown2Context.Provider>
